...
//		}
	...
	//	System.out.println(expr + "\t\t"+expr.getArgs() + "\t\t" + expr.getMethod() + "\t\t" + expr.getMethodRef() );
		...
		if(isMethodAvailable(newMethod, m.getDeclaringClass()))
			return;
	...
	private boolean isMethodAvailable(SootMethod newMethod, SootClass c) {
		// TODO Auto-generated method stub
		for(SootMethod m : c.getMethods()){
			if(m.getSubSignature().equals(newMethod.getSubSignature()))
				return true;
		}
